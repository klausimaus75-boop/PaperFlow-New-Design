...
export const modules = [
  {
    ...
    icon: Lightbulb,
    description:
      "Was kann der Bot, Aufgabenstellung, damit man das erste Ergebnis sieht, Übungsaufgaben, Ergebnisbeispiele.",
    benefits: ["Bot-Funktionen verstehen", "Erste Aufgabenstellung formulieren", "Ergebnisbeispiele und Übungen nutzen"]
  },
  {
    number: 2,
    slug: "bucherstellung",
