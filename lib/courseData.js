...
export const courseBenefits = [
  {
    title: "Start & Buchfundament",
    moduleRange: "Module 1-5",
    href: "/module/spass-mit-dem-bot",
    description: "Bot-Einstieg, Buchideen, Zielgruppe, Marktanalyse und Buchkonzept als sauberes Fundament.",
    icon: Lightbulb
  },
  {
    title: "Prompten & eigene GPTs",
    moduleRange: "Module 6-7",
    href: "/module/prompten-wie-ein-profi",
    description: "Prompts klar bauen und eigene Buchassistenten für Stil, Prüfung und Projektlogik planen.",
    icon: PencilLine
  },
  {
    title: "Buchtypen entwickeln",
    moduleRange: "Module 8-12",
    href: "/module/malbuecher-erstellen",
    description: "Malbücher, Kinderbücher, Rätsel, Escape-Room-Bücher, E-Books und Ratgeber entwickeln.",
    icon: BookOpen
  },
  {
    title: "Design, Bildstil & Text",
    moduleRange: "Module 13-15",
    href: "/module/coverdesign-verstehen",
    description: "Coverwirkung, Illustrationsstil und KI-Texte professionell planen, prüfen und verbessern.",
    icon: Brush
  },
  {
    title: "Layout & Qualitätsprüfung",
    moduleRange: "Module 16-17",
    href: "/module/buchlayout-mit-canva",
    description: "Canva-Innenlayout, Druckdaten, Checklisten, Gegenprobe und Freigabeprozess absichern.",
    icon: UploadCloud
  },
  {
    title: "KDP, Verkauf & Marketing",
    moduleRange: "Module 18-20",
    href: "/module/kdp-veroeffentlichung",
    description: "KDP-Veröffentlichung, Keywords, Verkaufsseite und Marketing ohne Geldverbrennung.",
    icon: Megaphone
  }
];
