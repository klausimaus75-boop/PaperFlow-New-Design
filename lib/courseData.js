...
export const courseBenefits = [
  { title: "Ideen entwickeln", icon: Lightbulb },
  { title: "Prompts beherrschen", icon: PencilLine },
  { title: "Buchtypen bauen", icon: BookOpen },
  { title: "Design prüfen", icon: Brush },
  { title: "KDP vorbereiten", icon: UploadCloud },
