  ...
  return (
    <section className="section-shell py-16">
      <div className="card max-w-4xl p-8">
        ...
        <p className="mt-6 text-slate-700">Angaben gemäß § 5 TMG. Dies ist ein Platzhalter für die rechtlichen Angaben des Kursanbieters.</p>
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700">Platzhalter für allgemeine Geschäftsbedingungen. Bitte vor Veröffentlichung rechtlich prüfen lassen.</p>
        <h2 id="widerruf" className="mt-10 text-2xl font-black text-navy">Widerruf</h2>
        <p className="mt-3 text-sm leading-7 text-slate-700">Platzhalter für Widerrufsinformationen und Verbraucherhinweise.</p>
      </div>
    </section>
  );
}
